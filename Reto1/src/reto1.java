...
public class reto1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (data.length == cant) {
            ...
            // var students = r.getCleanDataByCriteria(data_cast, "students");
            ...
            System.out.println(String.format("%.2f", r.getVarianza(scores)).replace(",", "."));
            System.out.println(r.getClasificationScore(data_cast).get("Sobresaliente").size());
            ...
            if (data_genre_course != null && data_genre_scores != null) {
                System.out.println(r.getWorstCourseAverageByGenre(data_genre_course, data_genre_scores));
            } else {
            ...
            if (data_genre_course != null && data_genre_scores != null) {
                System.out.println(r.getBestPerformanceByCourse(data_course_student, data_course_score));
            } else {
    ...
    public double getVarianza(List<Double> universe) {
